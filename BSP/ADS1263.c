...
//     HAL_Delay(1);
//     ADS1263_RESET_HIGH();
//     // ADS1263_WriteReg(, 0x11);
//     // ADS1263_WriteReg(ADS1263_INTERFACE ,Interface);
//     HAL_Delay(delayms);
//     ADS1263_WriteReg(ADS1263_Mode_0, 0x11);
...
//     ADS1263_WriteReg(ADS1263_IDACMUX,IDACMUX_setting);
//     ADS1263_WriteReg(ADS1263_IDACMAG,IDACMAG_setting);
//     ADS1263_WriteReg(ADS1263_REFMUX, REFMUX_setting);
...
//     ADS1263_START();
//     printf("waiting\n");
//     // HAL_SPI_Transmit(&hspi1, &sfocal_cmd, 1, 1000);
//     HAL_Delay(7000);
